...
class Game {
	...
	public static void panel_game() {
		...
		for (int i = 0; i <= 2; i++) {
			...
			icon_path[i] = System.getProperty("user.dir")+"/RockPaperScissors_JAVA_GUI/" + "/images/" + i + ".png";
	...
	public static void compute_winner(int choice_human) {
		...
		JLabel image_human = new JLabel(
				new ImageIcon(System.getProperty("user.dir") +"/RockPaperScissors_JAVA_GUI/"+ "/images/" + (choice_human - 1) + ".png"));
		image_human.setBounds(10, 100, 200, 250);
		score_panel.add(image_human);

		JLabel image_computer = new JLabel(
				new ImageIcon(System.getProperty("user.dir") +"/RockPaperScissors_JAVA_GUI/"+ "/images/" + (choice_computer - 1) + "c.png"));
